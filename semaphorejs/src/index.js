...
const private_key = "0001020304050607080900010203040506070809000102030405060708090001"
...
const tree = build_merkle_tree_example(20, privateVote.get_id_commitment(private_key).id_commitment)
// const tree = build_full_merkle_tree_example(10, 512, privateVote.get_id_commitment(private_key).id_commitment)
// console.log(tree)
const identity_path =  {
